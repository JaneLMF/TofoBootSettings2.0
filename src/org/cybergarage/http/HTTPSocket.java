...
public class HTTPSocket
{
			...
			long contentOffset, long contentLength, boolean isOnlyHeader)
	{
		...
		try
		{
			...
			while (0 < readLen && readCnt < contentLength)
			{
				...
				Log.e("InputStream readSize", readSize+"");
	 ...
	 * @return
	 */
//	private boolean post(HTTPResponse httpRes, SmbRandomAccessFile smbRadFile,
//			long contentOffset, long contentLength, boolean isOnlyHeader)
//	{
//		// TODO Check for bad HTTP agents, this method may be list for
//		// IOInteruptedException and for blacklistening
...
//			{
//				// 设置流的起始位置
//				//smbRadFile.skipBytes((int)contentOffset);
//				Log.e("contentOffset", contentOffset+"");
//				smbRadFile.seek(contentOffset);
//			}
//
//			// 获取块大小
//			int chunkSize = HTTP.getChunkSize();
...
//			long readSize = (chunkSize < contentLength) ? chunkSize
//					: contentLength;
//			int readLen = smbRadFile.read(readBuf, 0, (int) readSize);
//
//			while (0 < readLen && readCnt < contentLength)
//			{
//				if (isChunkedResponse == true)
...
//				readSize = (chunkSize < (contentLength - readCnt)) ? chunkSize
//						: (contentLength - readCnt);
//				readLen = smbRadFile.read(readBuf, 0, (int) readSize);
//			}
//
//			// 结束标记
//			if (isChunkedResponse == true)
...
//		}else if(httpRes.hasContentInputSmbRadFile()){
//			return post(httpRes, httpRes.getContentInputSmbRdaFile(),
//					contentOffset, contentLength, isOnlyHeader);
//		}
