...
public  class BluetoothDeviceFilter {
    ...
    public final static  int FILTER_TYPE_ALL = 0;
    public final static int  FILTER_TYPE_AUDIO = 1;
    public final static int  FILTER_TYPE_TRANSFER = 2;
    public final static int  FILTER_TYPE_PANU = 3;
    public final static int  FILTER_TYPE_NAP = 4;
    public final static int  FILTER_TYPE_HID = 5;
