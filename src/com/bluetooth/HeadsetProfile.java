  ...
  //  private final LocalBluetoothProfileManager mProfileManager;
    ...
    private final class HeadsetServiceListener
        ...
        public void onServiceConnected(int profile, BluetoothProfile proxy) {
            if (V) Log.d(TAG,"Bluetooth Headset   service connected");
   ...
   public HeadsetProfile(Context context, BluetoothAdapter adapter) {
    	...
    	adapter.getProfileProxy(context, new HeadsetServiceListener(),
                  BluetoothProfile.HEADSET);
    }
    ...
    public int getNameResource(BluetoothDevice device) {
        return 0;//R.string.bluetooth_profile_headset;
    }
    ...
    public int getSummaryResourceForDevice(BluetoothDevice device) {
        ...
        switch (state) {
            case BluetoothProfile.STATE_DISCONNECTED:
                return  0;//R.string.bluetooth_headset_profile_summary_use_for;

            case BluetoothProfile.STATE_CONNECTED:
                return 0;//R.string.bluetooth_headset_profile_summary_connected;
    ...
    public int getDrawableResource(BluetoothClass btClass) {
        return 0;//R.drawable.ic_bt_headset_hfp;
    }
