...
public class WifiUtils {
	...
	public final static int SECURITY_WPA = 1;
	public final static int SECURITY_WEP = 2;
	public final static int SECURITY_EAP = 3;
	public final static int SECURITY_UNKNOW = 4;
	public final static int SECURITY_WPA_WPA2 = 5;
	public final static int SECURITY_WPA2 = 6;
	...
	public static State getEthConnectState(Context context) {

		ConnectivityManager connManager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
		State mEthState = connManager.getNetworkInfo(ConnectivityManager.TYPE_ETHERNET).getState();
		return mEthState;
	}
	public static State getWifiConnectState(Context context) {
		
		ConnectivityManager connManager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
		State mEthState = connManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState();
		return mEthState;
	}
}